...
namespace Windpost.Input
{
    public sealed class DesktopInputSource : IInputSource
    {
        ...
        public DesktopInputSource(InputActionAsset inputActions)
        {
            if (inputActions == null)
            {
                Debug.LogError("[DesktopInputSource] InputActionAsset is null; all inputs will read default values.");
                return;
            }
            ...
            if (gameplay == null)
            {
                Debug.LogError("[DesktopInputSource] Action map 'Gameplay' not found; all inputs will read default values.");
                return;
            }
